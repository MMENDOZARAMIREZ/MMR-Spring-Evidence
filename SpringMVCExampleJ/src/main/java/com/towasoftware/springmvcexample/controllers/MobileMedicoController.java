...
import com.towasoftware.springmvcexample.bd.Consulta;
import com.towasoftware.springmvcexample.bd.Delete;
import com.towasoftware.springmvcexample.bd.Insert;
import com.towasoftware.springmvcexample.bd.Update;
...
public class MobileMedicoController {
	...
	public @ResponseBody Medico updateUser(@RequestBody Medico medico, @PathVariable Integer id)
			throws SQLException {
